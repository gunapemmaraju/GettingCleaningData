...
Y1<-rbind(Y_test,Y_train)

sub_test<-read.table("./UCI HAR Dataset/test/subject_test.txt")
sub_train<-read.table("./UCI HAR Dataset/train/subject_train.txt")
sub1<-rbind(sub_test,sub_train)
...
#Step3: I am still keeping the X's and Y's separately. I wan't sure if this merging was required
...
#Step5 - First the Value columns are extracted. And then using split apply combine, the required tidying is achieved. 
